...
; Modified to use Win key instead of Alt
...
~LWin::
~RWin::
DoubleAlt := (A_PriorHotkey = "~LWin" or A_PriorHotkey = "~RWin") and A_TimeSincePriorHotkey < 400
Sleep 0
KeyWait, % SubStr(A_ThisHotkey, 2)  ; Wait for the specific Win key to be released (prevents auto-repeat)
return